...
public class Doclogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon("C:\\Users\\keert\\OneDrive\\Desktop\\Screenshot 2023-12-13 134122.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            ResultSet rs=stmt.executeQuery("select * from doclogin");
            while(rs.next())
            {
                usernames.add(rs.getString(1));
                passwords.add(rs.getString(2));
                docname.add(rs.getString(3));
            }
            ...
            if(usernames.contains(username))
            {
                ...
                {
                    dispose();
                    Docview docview=new Docview(docname.get(i));
