...
public class Remarks extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            {
               // String x="update patientdetails set 'Remark' ='"+remark+"' where 'name'='"+name+"'";
                String x = "UPDATE patientdetails SET remarks = ? WHERE name = ?";
                
                PreparedStatement ps =  con.prepareStatement(x);
                ps.setString(1,remark);
                ps.setString(2,name);
                ps.executeUpdate();
                JOptionPane.showMessageDialog(null, "Remarks added Successfully :) ", "REMARKS",JOptionPane.INFORMATION_MESSAGE);
                dispose();
                //int result=stmt.executeUpdate(x);
            }
            else
            {
