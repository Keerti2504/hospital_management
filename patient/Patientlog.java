...
public class Patientlog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon("C:\\Users\\keert\\OneDrive\\Desktop\\Screenshot 2023-12-13 135354.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs;
            rs=stmt.executeQuery("select * from patientdetails");
            ArrayList<String> userids=new ArrayList<>();
            ArrayList<String> passwords=new ArrayList<>();
            while(rs.next())
            {
                userids.add(rs.getString(2));
            ...
            if(userids.contains(userid))
            {
                ...
                {
                    dispose();
                    PATIENTVIEW PV=new PATIENTVIEW(userid);
                    PV.setVisible(true);
                }
                else{
